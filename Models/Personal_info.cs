...
namespace newProjectTp3.Models
{
    public class Personal_info
    {
        public List<Person> GetAllPerson()
        {
            ...
            SQLiteConnection connection = new SQLiteConnection("Data Source=C:\\Users\\Nada\\OneDrive\\Desktop\\.net\\2022 GL3 .NET Framework TP3 - SQLite database.db;");
            connection.Open();
            
            using (connection)
            {
                var stm = "SELECT * FROM personal_info";
